...
echo Compilation...
"%JAVAC_EXE%" --module-path "%MODULE_PATH%" --add-modules javafx.controls,javafx.fxml,javafx.graphics -cp "%COMPILE_CP%" -d "%TARGET_DIR%" -sourcepath "%SRC_DIR%" "%SRC_DIR%\org\example\Main.java"
