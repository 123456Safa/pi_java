-- ===============================================
-- PHARMAX - Ajout des produits de test
-- Exécute ce script dans MySQL Workbench
-- ===============================================
...
SELECT COUNT(*) as 'Produits actuels' FROM produits;

-- 3. Insérer les 25 produits de test
...
SELECT COUNT(*) as 'Total produits' FROM produits;
