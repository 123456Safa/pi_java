...
import controllers.BackOfficeNotificationController;
...
public class AppBarController {
    ...
    private void onNotifications() {
        try {
            ...
            BackOfficeNotificationController controller = loader.getController();
            ...
            Button fermerBtn = (Button) dialogPane.lookupButton(dialogPane.getButtonTypes().stream()
                .filter(b -> b.getButtonData() == ButtonBar.ButtonData.CANCEL_CLOSE).findFirst().orElse(null));
            if (fermerBtn != null) {
    ...
    public void setSection(String title, String subtitle) {
