...
public class BackOfficeNotificationController {
    ...
    public void initialize() {
        ...
        if (filterGroup != null && btnFilterNonLu != null) {
                ...
                if (p.getDateExpiration() != null) {
                    ...
                    if (!state.isDismissed()) {
                        ...
                        if (p.getDiscountPercentage() > 0) {
                            msg += "\n🔥 OFFRE : -" + (int)p.getDiscountPercentage() + "% | Code : " + p.getPromoCode();
                        }
    ...
    private void applyFilter() {
        if (lvProduits == null) return;

        if (btnFilterNonLu != null && btnFilterNonLu.isSelected()) {
