...
public class AIService {
    ...
    public String generateArticle(String keyword) throws IOException {
        ...
        body.addProperty("prompt",
                "Write a professional French health article about: " + safeKeyword +
                        ". Strict limit: maximum 500 words. Do not exceed this limit. Format with intro, 2 sections, and conclusion.");
        body.addProperty("stream", false);

        JsonObject options = new JsonObject();
        options.addProperty("num_predict", 800);
