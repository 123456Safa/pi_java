@echo off
REM Script batch pour lancer l'application avec les paramètres JavaFX corrects
...
REM Modules JavaFX (utiliser le séparateur Windows ;)
...
"%JAVA_EXE%" --module-path "%MODULE_PATH%" --add-modules javafx.controls,javafx.fxml --enable-native-access javafx.graphics -Dfile.encoding=UTF-8 -classpath "%CLASSPATH%" org.example.Main
