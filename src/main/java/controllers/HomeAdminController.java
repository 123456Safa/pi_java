...
public class HomeAdminController {
    ...
    @FXML
    private Label sansReponse2JoursLabel;
        ...
        List<Reclamation> filtered = allReclamations.stream()
                .filter(r -> {
                    ...
                    if (!searchText.isEmpty()) {
                        ...
                        String reponseCountStr = String.valueOf(reponseCount);
                        
                        // Search by title, description or number of responses
                        if (!titre.contains(searchText) && 
                            !description.contains(searchText) && 
                            !reponseCountStr.contains(searchText)) {
                            return false;
                        }
                    }
